...
//somehow can't implement Tx vector, i use UDRE_empty vector instead. TODO: replace with Tx interrupt, should be shorter
...
int main(){
	...
	ADMUX	=0<<REFS1|0<<REFS0;//set analog reference voltage AREF with internal Vref turned off
	sei();
	idle();
}
